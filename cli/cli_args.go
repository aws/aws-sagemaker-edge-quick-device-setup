...
func ParseArgs(cliArgs *CliArgs) {
	...
	enableDB := flag.Bool("enableDB", false, "Enable DB for metrics backup and deployment")
	enableDeployment := flag.Bool("enableDeployment", false, "Enable deployment library")
	cwd, err := os.Getwd()
